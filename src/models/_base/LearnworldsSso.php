 ...
 * property or method in class "dzlab\learnworlds\models\LearnworldsSso".
 *
 * This is the model base class for the table "learnworlds_sso".
 ...
 * @property mixed $user
 */
abstract class LearnworldsSso extends ActiveRecord
{
	/**
	 * Constructor
	 */
	...
	{
		return Yii::t('app', 'LearnworldsSso|LearnworldsSsos', $n);
	}
